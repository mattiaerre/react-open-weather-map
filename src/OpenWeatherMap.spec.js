...
describe('<OpenWeatherMap />', () => {
  describe('when rendered w/o data', () => {
    ...
    it.skip('then it should be empty', () => {
      wrapper.should.be.empty; // eslint-disable-line no-unused-expressions
    });
  });
  ...
  describe('when rendered w/ an openweathermap current weather data object', () => {
    ...
    it('then it should not be empty', () => {
      wrapper.should.not.be.empty; // eslint-disable-line no-unused-expressions
    });
